...
st.markdown("<br><hr><center>Made with ❤️ by <a href='tareq=tarakkhan547@gmail.com?subject=ChatGPT + DALL-E WebApp!&body=Please specify the issue you are facing with the app.'><strong>Tareq Khan</strong></a></center><hr>", unsafe_allow_html=True)
